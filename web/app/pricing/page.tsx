  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <nav className="border-b border-slate-800 px-6 py-4 flex items-center justify-between">
        <Link href="/" className="text-lg font-black tracking-tight text-teal-400">TaxOverchargeReclaimDesk</Link>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <div className="mx-auto mt-12 max-w-md rounded-2xl border border-teal-800 bg-slate-900 p-8 text-left">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-teal-300">Free</h2>
          ...
          <Link
            href="/auth/sign-up"
            className="mt-8 block rounded-lg bg-teal-600 px-6 py-3 text-center font-semibold text-white hover:bg-teal-500"
          >
            Get started free
          </Link>
